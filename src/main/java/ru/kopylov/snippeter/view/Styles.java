...
/**
 * Стили CSS, каждая константа начинается с названия класса в котором используется
 */
public class Styles {
    public static String ResearchView_TexstStyle = "-fx-border-color: black; -fx-background-color: white; -fx-font-size: 140%";
